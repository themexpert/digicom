...
<div id="digicom">
	...
	<div class="digicom-form-account">
	...
	function populateShipping () {
	   ...
	   request_processed = 1;
		...
		<form action="index.php?option=com_digicom" method="post" name="adminForm" id="adminForm" onsubmit="return validateForm();" class="form-horizontal">
			<h2 class="digi-section-title"><?php echo JText::_('DSPROFILESETTINGS'); ?></h2>
			<div class="row-fluid">
			...
			<h2 class="digi-section-title"><?php echo JText::_('DSLOGININFO'); ?></h2>
			<div class="row-fluid">
				<div class="control-group">
			...
			<?php if($configs->get('askforbilling','0') == 1){ ?>
				<h2 class="digi-section-title"><?php echo JText::_('DSBILLINGADR'); ?></h2>
				<div class="row-fluid">
					<div class="control-group">
