...
?>
<table id="digicomcartpromo" class="table well" width="100%">
  <tr valign="top">
    <td class="general_text" colspan="<?php echo $table_column-1; ?>" valign="bottom">
      <?php echo JText::_("COM_DIGICOM_CART_IF_PROMOCODE_LABEL"); ?>
    </td>
    <td>
        <div class="digi_cart_subtotal_title text-right">
          <?php echo JText::_("COM_DIGICOM_SUBTOTAL");?>
        </div>
    </td>
    <td>
        <div class="digi_cart_subtotal_price text-right" data-digicom-id="cart_subtotal" style="font-size: 15px;text-align:right;">
