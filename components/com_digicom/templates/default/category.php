...
<div id="digicom">
	<div class="digi-categories">
		...
		<!-- Category Info -->
		<div class="category-info media clearfix">
				  ...
				  <li class="<?php echo $bsGrid[$this->configs->get('category_cols','3')]?>">
	                <div class="thumbnail">
	                	<!-- Product Image -->
	                  	...
	                  	<?php endif; ?>
	                  	<!-- Product price -->
					  	<p class="price"><span class="label"><?php echo DigiComSiteHelperDigicom::format_price2($item->price, $this->configs->get('currency','USD'), true, $this->configs); ?></span></p>
					  	...
					  	<div class="caption">
							...
							<!-- Readmore Button -->
		                    <p>
		                    	<a href="<?php echo $link;?>" class="btn btn-primary"><?php echo JText::_('COM_DIGICOM_PRODUCT_DETAILS'); ?></a>
		                    </p> 
	                  	</div>
	                </div>
	              </li>
