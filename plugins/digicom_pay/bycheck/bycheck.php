...
$lang->load('plg_digicom_pay_bycheck', JPATH_ADMINISTRATOR);
require_once(JPATH_SITE.'/plugins/digicom_pay/bycheck/bycheck/helper.php');
class plgDigiCom_PayByCheck extends JPlugin 
{
	var $_payment_gateway = 'bycheck';
	var $_log = null;
	...
	{
		$log = plgDigiCom_PayBycheckHelper::Storelog($this->_name,$data);
	}
}
