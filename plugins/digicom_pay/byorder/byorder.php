...
$lang->load('plg_digicom_pay_byorder', JPATH_ADMINISTRATOR);
if(JVERSION >='1.6.0')
	require_once(JPATH_SITE.'/plugins/digicom_pay/byorder/byorder/helper.php');
else
	require_once(JPATH_SITE.'/plugins/digicom_pay/byorder/helper.php');
class plgDigiCom_PayByOrder extends JPlugin 
{
	...
	{
			$log = plgDigiCom_PayByOrderHelper::Storelog($this->_name,$data);
