		...
		<div class="row-fluid">
			<div class="span12">
				...
				<ul class="nav nav-tabs">
				  ...
				  <li role="presentation" class="active"><a href="<?php echo JRoute::_('index.php?option=com_digicom&view=email&type=order'); ?>">Order</a></li>
				  <li role="presentation"><a href="<?php echo JRoute::_('index.php?option=com_digicom&view=email&type=approved'); ?>">Approved</a></li>
				</ul>
		...
		<div class="row-fluid">
			<div class="span8">
				<fieldset class="adminform">
					...
					<legend><?php echo JText::_('VIEWCONFIGORDERCONFORMATIONEMAIL');?></legend>
					...
					<div class="control-group ">
						<textarea id="order_editor" name="body" class="useredactor" style="width:90%;height:550px;"><?php echo $this->template->body; ?></textarea>
					</div>
			...
			<div class="span4">
				<div>
					...
					<table class="table table-condensed">
						...
						<tr>
							<td width=200><?php echo JText::_( 'VIEWCONFIGTEMPLATESHIPADDRESS' ); ?></td>
							<td width=200><span class="label label-info">[SHIPPING_ADDRESS]</span></td>
						</tr>
						<tr>
