...
<?php endif;?>
		<div class="row-fluid">
			<div class="span12">
				...
				<ul class="nav nav-tabs">
				  <li role="presentation" class="active"><a href="<?php echo JRoute::_('index.php?option=com_digicom&view=email'); ?>">Register</a></li>
	...
	<div>
		<input type="hidden" name="jform[type]" value="register" />
