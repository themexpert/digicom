...
<form action="<?php echo JRoute::_('index.php?option=com_digicom&controller=categories&task=edit&cid[]=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
