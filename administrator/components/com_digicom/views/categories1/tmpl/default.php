...
<form action="<?php echo JRoute::_('index.php?option=com_digicom&controller=categories'); ?>" method="post" name="adminForm" id="adminForm">
						...
						<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->parent_id; ?>" item-id="<?php echo $item->id ?>" parents="<?php echo $parentsStr ?>" level="<?php echo $item->level ?>">
							...
							<td>
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_digicom&controller=category&task=edit&id=' . $item->id); ?>">
