	...
	<table class="table table-striped">
		<tr>
			...
			<td style="border-top:1px solid #ccc;padding-top:5px;">
				<div style="float:left;margin-right: 15px;padding-top: 4px;">
					<span id="product_<?php echo $type; ?>_name_text_<?php echo $id_rand; ?>"><?php echo JText::_("SELECT_PRODUCT");?></span>
