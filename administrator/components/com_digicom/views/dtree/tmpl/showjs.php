...
d.add(8121,812,'&nbsp;<?php echo JText::_('DIGICOM_NEWPRODUCT_DOWNLOADABLE');?>','index.php?option=com_digicom&controller=products&task=add&product_type=0','<?php echo JText::_('VIEWPRODPRODTYPEDNR');?>','','components/com_digicom/assets/images/icons/small/packages.png','components/com_digicom/assets/images/icons/small/packages.png','components/com_digicom/assets/images/icons/small/packages.png');
//d.add(8122,812,'&nbsp;<?php echo JText::_('DIGICOM_NEWPRODUCT_DOWNLOADABLE_DOMAIN');?>','index.php?option=com_digicom&controller=products&task=add&product_type=1','<?php echo JText::_('VIEWPRODPRODTYPEDR');?>','','components/com_digicom/assets/images/icons/small/packages.png','components/com_digicom/assets/images/icons/small/packages.png','components/com_digicom/assets/images/icons/small/packages.png');
//d.add(8123,812,'&nbsp;<?php echo JText::_('DIGICOM_NEWPRODUCT_SHIPABLE');?>','index.php?option=com_digicom&controller=products&task=add&product_type=2','<?php echo JText::_('VIEWPRODPRODTYPESP');?>','','components/com_digicom/assets/images/icons/small/packages.png','components/com_digicom/assets/images/icons/small/packages.png','components/com_digicom/assets/images/icons/small/packages.png');
d.add(8124,812,'&nbsp;<?php echo JText::_('DIGICOM_NEWPRODUCT_PACKAGE');?>','index.php?option=com_digicom&controller=products&task=add&product_type=3','<?php echo JText::_('VIEWPRODPRODTYPEPAK');?>','','components/com_digicom/assets/images/icons/small/packages.png','components/com_digicom/assets/images/icons/small/packages.png','components/com_digicom/assets/images/icons/small/packages.png');
//d.add(8125,812,'&nbsp;<?php echo JText::_('DIGICOM_NEWPRODUCT_SERVICE');?>','index.php?option=com_digicom&controller=products&task=add&product_type=4','<?php echo JText::_('VIEWPRODPRODTYPESERV');?>','','components/com_digicom/assets/images/icons/small/packages.png','components/com_digicom/assets/images/icons/small/packages.png','components/com_digicom/assets/images/icons/small/packages.png');
