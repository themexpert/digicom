...
?>
 ...
 <form action="index.php" method="post" name="adminForm" id="adminForm">
		...
		<fieldset class="adminform">
			<legend><?php echo JText::_('VIEWPRODUCTTAXCLASS');?></legend>
				<table class="admintable">

				<tr>
					<td>
					<?php echo JText::_('VIEWPRODUCTTAXCLASSNAME');?>:
					</td>
					<td >
				...
				<tr>
					<td>
					<?php echo JText::_('VIEWTAXPRODUCTCLASSORDERING');;?>:
					</td>
					<td>
				...
				<tr>
					<td>
					<?php echo JText::_('VIEWTAXPRODUCTCLASSPUBLISHED');?>
					</td>
					<td>
