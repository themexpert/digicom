...
class DigiComAdminViewTaxProductClasses extends DigiComView {
	...
	function display ($tpl =  null )
	{
		...
		JToolBarHelper::title(JText::_('DSTAXPRODUCTCLASSESMANAGER'), 'generic.png');
	...
	function editForm($tpl = null) {
		...
		JToolBarHelper::title(JText::_('DSTAXPRODUCTCLASS').":<small>[".$text."]</small>");
		JToolBarHelper::save();
		if ($isNew) {
			JToolBarHelper::divider();
		...
		. ' FROM `#__digicom_tax_productclass`'
		. ' ORDER BY ordering'
		;
