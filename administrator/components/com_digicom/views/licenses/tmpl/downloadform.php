...
?>
	<form id="adminForm" name="form1" method="post" action="index.php">
...
<?php
$mosConfig_live_site = DigiComAdminHelper::getLiveSite();
?>
  ...
  <tr class="row1">
	...
	<td><select name="platforms[]" size="5" id="platforms">
		<?php 
//  $platforms = explode (" ", $res->platforms);
  ...
  <tr>
<td>Generate only license file</td><td> <input type="checkbox" value="1" name="licenseonly" /></td>
</tr><tr>
...
<input name="cid" type="hidden" id="cid" value="<?php echo $license->id?>">
