...
<?php endif;?>
		...
		<?php echo JHtml::_('bootstrap.startTabSet', 'digicomTab', array('active' => 'sales')); ?>
			...
			<ul class="nav nav-pills">
			  <li class="active">
			    <a href="index.php?option=com_digicom&view=stats">Overview</a>
			  </li>
			  <li>
			  	<a href="index.php?option=com_digicom&view=stats">Daily</a>
			  </li>
			  <li>
			  	<a href="index.php?option=com_digicom&view=stats">Weekly</a>
			  </li>
			  <li>
			  	<a href="index.php?option=com_digicom&view=stats">Monthly</a>
			  </li>
			  <li>
			  	<a href="index.php?option=com_digicom&view=stats">Yearly</a>
			  </li>
			  <li>
			  	<a href="index.php?option=com_digicom&view=stats">Custom</a>
			  </li>
			</ul>
		...
		<table style="background-color:#F7F7F7; height: 30px; /*width: 400px; */color:#C4C3BA;">
			<tr>
				<td align="left" width="<?php if($report == "monthly"){echo "40";}else{echo "25";} ?>%">
					...
					?>
					<a href="index.php?report=<?php echo $report; ?>&view=stats&option=com_digicom&task=showStats&action=prev&pas=<?php echo ++$pas;?>">
						<?php
				...
				<td align="right" width="<?php if($report == "monthly"){echo "40";}else{echo "25";} ?>%">
					<?php
						...
						if($pas != "0"){
					?>
							<a href="index.php?report=<?php echo $report; ?>&view=stats&option=com_digicom&task=showStats&action=next&pas=<?php echo --$pas;?>">
							<?php
