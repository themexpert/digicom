...
<li id="mod_digicom_cart_wrap" class="mod_digicom_cart<?php echo $class_sfx; ?> mod_digicom_cart_wrap dropdown">
	<a class="dropdown-toggle" data-toggle="dropdown" href="<?php echo JRoute::_('index.php?option=com_digicom&controller=cart&task=showCart'.$and_itemid, false)?>">
...
?>
				...
				<div class="panel-footer text-right">
					<a class="btn btn-foo" href="<?php echo JRoute::_('index.php?option=com_digicom&controller=cart&task=showCart'.$and_itemid, false)?>" <?php echo (count($items) == 0) ? 'disabled="disabled"':''; ?>><i class="fa fa-shopping-cart fa-fw"></i> <?php echo JText::_('MOD_DIGICOM_CART_CHECKOUT'); ?></a>
				</div>
			</div>
		</li>
	</ul>
