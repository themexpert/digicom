...
ALTER TABLE  `#__digicom_products` ADD `version` int(10) unsigned NOT NULL DEFAULT '1' AFTER  `xreference`;
ALTER TABLE  `#__digicom_products` ADD `urls` text NOT NULL AFTER  `version`;

ALTER TABLE  `#__digicom_products` ADD INDEX  `idx_access` (  `access` );
ALTER TABLE  `#__digicom_products` ADD INDEX  `idx_checkout` (  `checked_out` );
ALTER TABLE  `#__digicom_products` ADD INDEX  `idx_state` (  `published` );
ALTER TABLE  `#__digicom_products` ADD INDEX  `idx_catid` (  `catid` );
ALTER TABLE  `#__digicom_products` ADD INDEX  `idx_createdby` (  `created_by` );
ALTER TABLE  `#__digicom_products` ADD INDEX  `idx_featured_catid` (`featured`,`catid`);
ALTER TABLE  `#__digicom_products` ADD INDEX  `idx_language` (`language`);
ALTER TABLE  `#__digicom_products` ADD INDEX  `idx_xreference` (`xreference`);
