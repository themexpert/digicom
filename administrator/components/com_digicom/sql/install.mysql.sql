...
INSERT IGNORE INTO `#__digicom_currencies` (`id`, `pluginid`, `currency_name`, `currency_full`)
VALUES
  (1,'1','USD','U.S. Dollar'),
...
INSERT IGNORE INTO `#__digicom_states` (`id`, `state`, `country`, `eumember`, `ccode`, `scode`)
VALUES
