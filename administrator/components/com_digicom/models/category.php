...
class DigiComModelCategory extends JModelAdmin
{
	...
	public function __construct($config = array())
	{
		...
		$extension = JFactory::getApplication()->input->get('extension', 'com_digicom');
	...
	protected function populateState()
	{
		...
		$extension = $app->input->get('extension', 'com_digicom');
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_digicom.category' . $extension, 'category', array('control' => 'jform', 'load_data' => $loadData));
	...
	/**
	 * Custom clean the cache of com_digicom and content modules
	 *
