 ...
 * @since  1.6
 */
class DigiComAdminModelCategory extends JModelAdmin
{
	/**
	 * @var    string  The prefix to use with controller messages.
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_DIGICOM';
	...
	public function __construct($config = array())
	{
		...
		$this->typeAlias = 'com_digicom.category';
	}
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'Category', $prefix = 'Table', $config = array())
	{
