 ...
 * @since  1.6
 */
class DigiComModelAbout extends JModelLegacy
{
	/**
	...
	public function &getPHPInfo()
	{
		...
		{
			$this->php_info = JText::_('COM_DIGICOM_ABOUT_SYSTEMINFO_PHPINFO_DISABLED');
	...
	public function getDirectory()
	{
		...
		$digiparams = JComponentHelper::getParams('com_digicom');
		$this->_addDirectory($digiparams->get('ftp_source_path','digicom'), JPATH_SITE . '/' . $digiparams->get('ftp_source_path','digicom'));
		...
		if ($cache_path = trim($registry->get('cache_path', '')))
		{
			...
			$this->_addDirectory($cache_path, $cache_path, 'COM_DIGICOM_ABOUT_SYSTEMINFO_CACHE_DIRECTORY');
		}
		else
		{
			$this->_addDirectory('cache', JPATH_SITE . '/cache', 'COM_DIGICOM_ABOUT_SYSTEMINFO_CACHE_DIRECTORY');
		}

		$this->_addDirectory($registry->get('log_path', JPATH_ROOT . '/log'), $registry->get('log_path', JPATH_ROOT . '/log'), 'COM_DIGICOM_ABOUT_SYSTEMINFO_LOG_DIRECTORY');
		$this->_addDirectory($registry->get('tmp_path', JPATH_ROOT . '/tmp'), $registry->get('tmp_path', JPATH_ROOT . '/tmp'), 'COM_DIGICOM_ABOUT_SYSTEMINFO_TEMP_DIRECTORY');
