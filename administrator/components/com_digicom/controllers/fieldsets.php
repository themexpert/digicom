...
class DigiComAdminControllerFieldsets extends DigiComAdminController {
	var $_model = null;
	...
	function __construct () {
		...
		$this->_model = $this->getModel("Fieldset");
		$this->registerTask ("unpublish", "publish");
	}

	function listFieldsets() {
		$view = $this->getView("Fieldsets", "html");
	...
	function save () {
		...
		$link = "index.php?option=com_digicom&controller=fieldsets";
