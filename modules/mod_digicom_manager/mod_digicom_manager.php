...
$after = $config->params->get('afterpurchase','1');
?>
...
?>
		...
		<tr <?php if($showl != 1) echo $invisible; ?> >
			<td align="left">
				<a href="<?php echo JRoute::_("index.php?option=com_digicom&view=downloads&Itemid=".$Itemid); ?>"><?php echo JText::_('MYLICANDDLS');?></a>
			</td>
		</tr>
...
?>
			<tr>
				<td align="left">
					<a href="<?php echo JRoute::_('index.php?option=com_digicom&view=profile&task=login&returnpage=downloads'."&Itemid=".$Itemid);?>"><?php echo JText::_('LOGINTOVIEW');?></a>
				</td>
			</tr>
<?php
		}
...
?>
			<tr>
				<td align="left">
					<a href="<?php echo JRoute::_('index.php?option=com_digicom&view=profile&task=login&returnpage=orders'."&Itemid=".$Itemid);?>"><?php echo JText::_('LOGINTOVIEW');?></a>
				</td>
			</tr>
<?php 
		}
