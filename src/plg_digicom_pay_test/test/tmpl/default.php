...
if($vars->custom_email==""){
	$email = JText::_('PLG_DIGICOM_PAY_TEST_AFTER_PAYMENT_CONTACT_NO_ADDRS');
}
else{
	...
	<form action="<?php echo $vars->url; ?>" name="adminForm" id="adminForm" class="form-validate form-horizontal"  method="post">
		<div>
			...
			<div class="control-group">
				<label for="cardlname" class="control-label"><?php echo JText::_( 'PLG_DIGICOM_PAY_TEST_PAYABLE_AMOUNT' ); ?></label>
			...
			<div class="form-actions">
				...
				<input type='hidden' name='processor' value="test" />
				...
				<?php if($buy_image) : ?>
					<input type="image" name="submit"
						...
						value="<?php echo JText::_('PLG_DIGICOM_PAY_TEST_SUBMIT'); ?>" 
