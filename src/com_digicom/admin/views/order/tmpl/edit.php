	...
	<div id="digicom" class="dc digicom">
		...
		<div class="tx-main">
			<div class="page-header">
				<h1><?php echo JText::sprintf('COM_DIGICOM_ORDER_DETAILS_HEADER_TITLE', $order->id)?></h1>
				<p><?php echo JText::sprintf('COM_DIGICOM_ORDER_DETAILS_HEADER_NOTICE',$date,$order->status); ?></p>
			</div>
			<div class="page-content">
				<div class="row">
					<div class="col-md-6">
						<div class="panel panel-default">
							<div class="panel-heading">Products</div> <!-- .panel-heading -->
							<table class="adminlist table table-striped table-hover">
								<thead>
									<tr>
										<th class="sectiontableheader">#</th>
										<th class="sectiontableheader"><?php echo JText::_('COM_DIGICOM_PRODUCT');?></th>
										<th class="sectiontableheader"><?php echo JText::_('COM_DIGICOM_ORDER_DETAILS_TOTAL_PRODUCT');?></th>
										<th class="sectiontableheader"><?php echo JText::_('COM_DIGICOM_PRICE');?></th>
									</tr>
								</thead>
								<tbody>
									<?php
									...
									<tr>
										...
										<td><?php echo DigiComHelperDigiCom::format_price($order->price, $order->currency, true, $configs); ?></td>
									</tr>
									<tr class="warning">
										<td colspan="2"></td>
									...
									<tr>
										<td colspan="4">
											<?php echo $this->form->getLabel('status'); ?><br>
							...
							<table class="adminlist table">
								...
								<tbody>
									...
									<tr>
										...
										<td class="warning"><?php echo $log->type;?></td>
										<td><?php echo $log->message;?></td>
										<td class="warning"><?php echo $log->status;?></td>
