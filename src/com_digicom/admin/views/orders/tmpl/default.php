...
<form id="adminForm" action="<?php echo JRoute::_('index.php?option=com_digicom&view=orders'); ?>" method="post" name="adminForm" autocomplete="off" class="form-validate">
  <div id="digicom" class="dc digicom">
    <div class="tx-sidebar"><?php echo $this->sidebar; ?></div> <!-- .tx-sidebar -->
    <div class="tx-main">
      <div class="page-header">
        <h1>Orders List</h1>
        <p><?php echo JText::_("COM_DIGICOM_ORDERS_HEADER_NOTICE"); ?></p>
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            <div class="collapse navbar-collapse">
              <?php echo JLayoutHelper::render('searchtools.orders', array('view' => $this)); ?>
            </div> <!-- navbar-collapse -->
          </div> <!-- container-fluid -->
        </nav> <!-- nav end -->
      </div> <!-- .page-header -->
      ...
      <div class="page-content">
        ...
        <table class="adminlist table table-striped">
          <thead>
            <tr>
              ...
              <th><?php echo JText::_( 'COM_DIGICOM_NUM_PRODUCT_IN_ORDER' ); ?></th>
              ...
              <th style="width: 200px;"><?php echo JText::_( 'COM_DIGICOM_ACTION' ); ?></th>
            </tr>
          </thead>
          <tbody>
            <?php
            ...
            ?>
              <tr class="row<?php echo $i; ?>">
                ...
                <td align="center">
                  <?php echo DigiComHelperDigiCom::format_price($order->amount, $configs->get('currency','USD'), true, $configs);
                  ?>
                </td>
                <td align="center">
                  <?php
                ...
                <td align="center" class="hide-mediam"><?php echo $order->processor; ?></td>
        ...
        <div class="well well-lg text-center">
          <h3 class="muted"><?php echo  JText::_('COM_DIGICOM_ORDERS_NOTICE_NO_ORDER_FOUND'); ?></h3>
        </div>
        <?php endif; ?>
