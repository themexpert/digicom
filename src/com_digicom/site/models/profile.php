...
/**
 * Profile model class for Digicom.
 *
 * @since  1.6
 */
class DigicomModelProfile extends JModelForm
{
	/**
	...
	public function getData()
	{
		if ($this->data === null)
		{
			...
			$temp = (array) JFactory::getApplication()->getUserState('com_digicom.edit.profile.data', array());
			...
			$results = $dispatcher->trigger('onContentPrepareData', array('com_digicom.profile', $this->data));
	...
	{
		// Get the form.
		$form = $this->loadForm('com_digicom.profile', 'profile', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$this->preprocessData('com_digicom.profile', $data);
	...
	protected function preprocessForm(JForm $form, $data, $group = 'user')
	{
		...
		$form->loadFile('profile_2fact', false);
	...
	protected function populateState()
	{
		...
		// Get the user id.
		$userId = JFactory::getApplication()->getUserState('com_digicom.edit.profile.id');
	...
	public function save($data)
	{
		...
		$user->tags->getTagIds($user->id, 'com_digicom.profile');
