...
class DigicomControllerResponses extends JControllerLegacy
{
    ...
    public $event_execute_request = 'onDigicomExecuteResponses';
    public $event_authenticate_request = 'onDigicomAuthenticateResponses';
    ...
    public function execute($task)
    {
        try
        {
            ...
            // Trigger the before delete event.
  					$result = $dispatcher->trigger($this->event_execute_request, $this->context);
    ...
    /**
     * Method to authenticate users license
     *
     * @return  output from plugin, can be json or xml
     *
     * @since   1.2.3
