...
/**
 * Smart Search adapter for com_digicom.
 *
 * @since  2.5
 */
class PlgFinderDigicom extends FinderIndexerAdapter
{
	/**
	...
	{
		// Make sure we're handling com_digicom categories.
		if ($extension == 'com_digicom')
		{
	...
	{
		if ($context == 'com_digicom.product')
		{
			$id = $table->id;
		}
	...
	public function onFinderAfterSave($context, $row, $isNew)
	{
		...
		if ($context == 'com_digicom.product' || $context == 'com_digicom.form')
		{
	...
	protected function setup()
	{
		...
		include_once JPATH_SITE . '/components/com_digicom/helpers/route.php';
